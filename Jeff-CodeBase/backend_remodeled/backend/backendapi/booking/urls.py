...
from .import views
from .views import BookedEvents, BookingView
...
router.register('bookings', views.BookingView, 'booking')
...
urlpatterns = [
    ...
    path('booking/bookinglist/', BookedEvents.as_view(), name='bookedlist'),
